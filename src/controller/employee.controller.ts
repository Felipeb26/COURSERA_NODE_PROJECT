...
import { findAll, save, findById, update, deleteById, findAllDepartments } from "../routes/employee.routes";
import { Endpoint } from "../domain/enums/endpoint.enum";

router.get(Endpoint.EMPLOYEE + "/departments", findAllDepartments)
